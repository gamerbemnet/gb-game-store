...
def proxy_ads():
    try:
        r=http_requests.get('http://pl29836648.effectivecpmnetwork.com/78/c8/6f/78c86f69ec008d2f9b114aa9d0e152fe.js',timeout=20,headers={'User-Agent':flask_request.headers.get('User-Agent',''),'Referer':flask_request.headers.get('Referer','')})
        ...
        print(f'Ad proxy failed: {e}',flush=True)

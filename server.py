...
if not db_find_one('games',{}):
    ...
    games_to_add=[
        dict(name="Minecraft Java",img="https://www.minecraft.net/content/dam/games/minecraft/key-art/Games_Subnav_702x400.jpg",downloadLink="",description="The classic sandbox building game. Mine resources, craft tools, and build anything you can imagine.",category="Adventure",addedBy="owner",id=now+1,downloads=247,views=892,size="500MB",developer="Mojang Studios",releaseDate="2011-11-18",version="1.20.4",featured=True,screenshots=[],tags=["sandbox","creative","survival","multiplayer"],minReqs="Intel Core i3, 4GB RAM",maxReqs="Intel Core i5, 8GB RAM",trailer="https://www.youtube.com/watch?v=MmB9b5njVbA",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Among Us",img="https://static.wikia.nocookie.net/among-us-wiki/images/3/39/Among_Us_cover_art.jpg",downloadLink="",description="Play online with 4-15 players. Identify the Impostor or cause chaos as one.",category="Puzzle",addedBy="owner",id=now+2,downloads=389,views=1205,size="250MB",developer="InnerSloth",releaseDate="2018-06-15",version="2024.3.21",featured=False,screenshots=[],tags=["multiplayer","social-deduction","party","casual"],minReqs="1GB RAM",maxReqs="4GB RAM",trailer="https://www.youtube.com/watch?v=WVHv1gMjSak",platform="Both",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Terraria",img="https://assets.terraria.org/canvas/terraria-logo-large.png",downloadLink="",description="Dig, fight, explore, build! A 2D sandbox adventure with countless possibilities.",category="Adventure",addedBy="owner",id=now+3,downloads=312,views=980,size="400MB",developer="Re-Logic",releaseDate="2011-05-16",version="1.4.4.9",featured=False,screenshots=[],tags=["sandbox","2d","survival","adventure","crafting"],minReqs="2GHz CPU, 2.5GB RAM",maxReqs="4GHz CPU, 8GB RAM",trailer="https://www.youtube.com/watch?v=GdpeN6X3J5k",platform="PC",ageRating="Everyone 10+",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Stardew Valley",img="https://images.unsplash.com/photo-1614294149010-950b698f72c0?w=1920",downloadLink="",description="Build the farm of your dreams. Raise animals, grow crops, befriend villagers, and find love.",category="RPG",addedBy="owner",id=now+4,downloads=203,views=760,size="500MB",developer="ConcernedApe",releaseDate="2016-02-26",version="1.6",featured=False,screenshots=[],tags=["farming","rpg","relaxing","pixel-art","simulation"],minReqs="2GHz CPU, 2GB RAM",maxReqs="3GHz CPU, 4GB RAM",trailer="https://www.youtube.com/watch?v=ot7u0fOpQcG",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="A Short Hike",img="https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1920",downloadLink="",description="Explore a peaceful island park. Climb to the summit of Hawk Peak for stunning views.",category="Adventure",addedBy="owner",id=now+5,downloads=356,views=1100,size="200MB",developer="adamgryu",releaseDate="2019-07-30",version="1.0",featured=True,screenshots=[],tags=["relaxing","exploration","adventure","pixel-art","indie"],minReqs="2GHz CPU, 1GB RAM",maxReqs="3GHz CPU, 2GB RAM",trailer="https://www.youtube.com/watch?v=3WfZ5vq1cJQ",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Undertale",img="https://images.unsplash.com/photo-1511512578047-dfb367046420?w=1920",downloadLink="",description="The RPG where nobody has to die. Your choices determine the ending of this indie classic.",category="RPG",addedBy="owner",id=now+6,downloads=421,views=1350,size="200MB",developer="Toby Fox",releaseDate="2015-09-15",version="1.08",featured=True,screenshots=[],tags=["rpg","indie","story-rich","pixel-art"],minReqs="2GHz CPU, 3GB RAM",maxReqs="3GHz CPU, 4GB RAM",trailer="https://www.youtube.com/watch?v=1Hq-cbLpHzo",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Brawlhalla",img="https://images.unsplash.com/photo-1511512578047-dfb367046420?w=1920",downloadLink="",description="Free-to-play platform fighter. Choose from 50+ legends with unique weapons and movesets.",category="Action",addedBy="owner",id=now+7,downloads=256,views=880,size="500MB",developer="Blue Mammoth Games",releaseDate="2014-10-17",version="8.12",featured=False,screenshots=[],tags=["fighting","platformer","multiplayer","free-to-play","casual"],minReqs="2GHz CPU, 1GB RAM",maxReqs="4GHz CPU, 4GB RAM",trailer="https://www.youtube.com/watch?v=yFyH5cVqFqE",platform="Both",ageRating="Everyone 10+",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Cuphead",img="https://images.unsplash.com/photo-1551103782-8ab07afd45c1?w=1920",downloadLink="",description="Classic run and gun action focused on boss battles. Inspired by 1930s cartoons.",category="Action",addedBy="owner",id=now+8,downloads=287,views=920,size="3GB",developer="Studio MDHR",releaseDate="2017-09-29",version="1.3.4",featured=False,screenshots=[],tags=["action","difficulty","cartoon","co-op","indie"],minReqs="Intel Core 2 Duo, 3GB RAM",maxReqs="Intel Core i5, 4GB RAM",trailer="https://www.youtube.com/watch?v=NNfWOG1yO48",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Downwell",img="https://images.unsplash.com/photo-1509114397022-ed747cca3f65?w=1920",downloadLink="",description="A minimalist action game about a boy jumping down a well. Simple controls, deep gameplay.",category="Action",addedBy="owner",id=now+9,downloads=178,views=640,size="50MB",developer="Moppin",releaseDate="2015-10-15",version="1.0",featured=False,screenshots=[],tags=["roguelike","minimalist","difficult","retro","indie"],minReqs="1GHz CPU, 512MB RAM",maxReqs="2GHz CPU, 1GB RAM",trailer="https://www.youtube.com/watch?v=UBS4Li4dK2Q",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
        dict(name="Baba Is You",img="https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1920",downloadLink="",description="A puzzle game where you change the rules by pushing blocks of text. 200+ mind-bending levels.",category="Puzzle",addedBy="owner",id=now+10,downloads=412,views=1290,size="100MB",developer="Hempuli",releaseDate="2019-02-13",version="1.0",featured=True,screenshots=[],tags=["puzzle","logic","innovative","indie","brain-teaser"],minReqs="1GHz CPU, 1GB RAM",maxReqs="2GHz CPU, 2GB RAM",trailer="https://www.youtube.com/watch?v=zHmynEO1Lqo",platform="PC",ageRating="Everyone",price="Free",dlcs=[],changelog=[],faq=[]),
    ]
